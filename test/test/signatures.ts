...
export const userPrivateKey = Buffer.from("f2863a607357690d3e8c41360d3e6b67975f9fd2c70af5e1e99ccdfc490c9796", "hex");
...
export const sign = (digest: any, privateKey: any) => {
  ...
  console.log(r.toString("hex"), s.toString("hex"), v.toString(16));
...
export function getPermitDigest(
  ...
  console.log("Paul PERMIT_TYPEHAH", PERMIT_TYPEHASH);
